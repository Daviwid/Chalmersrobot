...
class MainUI(QWidget):
    ...
    def initUI(self):
        ...
        self.ui.btnStartAll.clicked.connect(self.robotPrint) #gjort själv
        ...
        self.setWindowTitle('Chalmers Robot')
        self.setWindowIcon(QtGui.QIcon('mDraw.ico'))
        self.show()
...
#             raise Exception(e)
    ...
    def loadPic(self,filename=False): #används för bild senare
        if self.robot.printing:
            return        
        if filename==False:
